...
const ActualBoard: React.FC<{ data: MonthAgg[] }> = ({ data }) => {
  return (
    <div style={{ border: '1px solid #e5e7eb', borderRadius: 12, padding: 16 }}>
      ...
      <ResponsiveContainer width="100%" height={340}>
        <ComposedChart data={data} margin={{ top: 12, right: 24, bottom: 12, left: 12 }}>
          ...
          <YAxis yAxisId="L" label={{ value: '임대건수', angle: -90, position: 'insideLeft' }} />
          <YAxis
            yAxisId="R"
            orientation="right"
          ...
          <Tooltip />
          <Legend />
          <Bar  yAxisId="L" dataKey="rental"   name="임대건수" fill="#64748b" />
